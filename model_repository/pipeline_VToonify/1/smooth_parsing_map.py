...
from model_package.raft.core.raft import RAFT
from model_package.raft.core.utils.utils import InputPadder
from model_package.bisenet.model import BiSeNet
from model_package.stylegan.model import Downsample
...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument("--raft_path", type=str, default='./checkpoint/raft-things.pth', help="path of the RAFT model_package")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_package', help="restore checkpoint")
    parser.add_argument('--small', action='store_true', help='use small model_package')
    parser.add_argument('--mixed_precision', action='store_true', help='use mixed precision')
    parser.add_argument('--alternate_corr', action='store_true', help='use efficent correlation implementation')

    raft_model = torch.nn.DataParallel(RAFT(parser.parse_args(['--model_package', args.raft_path])))
