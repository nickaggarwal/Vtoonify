...
from util import *
from model_package.stylegan import lpips
from model_package.stylegan.model import Generator, Downsample
from model_package.vtoonify import VToonify, ConditionalDiscriminator
from model_package.bisenet.model import BiSeNet
from model_package.simple_augment import random_apply_affine
from model_package.stylegan.distributed import (
    get_rank,
    synchronize,
    reduce_loss_dict,
    reduce_sum,
...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--encoder_path", type=str, default=None, help="path to the pretrained encoder model_package")
        ...
        self.parser.add_argument("--stylegan_path", type=str, default='./checkpoint/stylegan2-ffhq-config-f.pt', help="path to the stylegan model_package")
        self.parser.add_argument("--finetunegan_path", type=str, default='./checkpoint/cartoon/finetune-000600.pt', help="path to the finetuned stylegan model_package")
        self.parser.add_argument("--weight", type=float, nargs=18, default=[1]*9+[0]*9, help="the weight for blending two models")
        self.parser.add_argument("--faceparsing_path", type=str, default='./checkpoint/faceparsing.pth', help="path of the face parsing model_package")
        self.parser.add_argument("--style_encoder_path", type=str, default='./checkpoint/encoder.pt', help="path of the style encoder")
        
        self.parser.add_argument("--name", type=str, default='vtoonify_t_cartoon', help="saved model_package name")
