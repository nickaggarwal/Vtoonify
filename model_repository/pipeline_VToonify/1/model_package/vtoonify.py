...
from model_package.stylegan.model import ConvLayer, EqualLinear, Generator, ResBlock
from model_package.dualstylegan import AdaptiveInstanceNorm, AdaResBlock, DualStyleGAN
...
class VToonify(nn.Module):
    def __init__(self,
        ...
        if self.backbone == 'dualstylegan':
            ...
            self.res.append(AdaResBlock(self.generator.channels[2 ** 2])) # for conv1, no use in this model_package
            for i in range(3, 6):
