# almost the same as model_package.stylegan.non_leaking
...
from model_package.stylegan.distributed import reduce_sum
from model_package.stylegan.op import upfirdn2d
