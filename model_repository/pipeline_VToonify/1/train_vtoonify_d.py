...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--stylegan_path", type=str, default='./checkpoint/cartoon/generator.pt', help="path to the stylegan model_package")
        ...
        self.parser.add_argument("--name", type=str, default='vtoonify_d_cartoon', help="saved model_package name")
